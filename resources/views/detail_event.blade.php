                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <p><b>SPORT</b></p>
                                <h3>Football Contest</h3>
                                <p><i class="material-icons">&#xe55f;</i> Cambodai, Phnom Penh</p>
                                <p><i class="material-icons">people</i> 16 members</p>
                                <p><i class="material-icons">person</i> Organized by: RADY</p>
                                <p><i style='font-size:23px' class='far'>&#xf017;</i> Monday,July 4:00PM-5:00PM </p>
                    ...
                    <div class="modal-body">
                        <p>How about this event? Join with me please! <br>Please go to this like for detail www.com.kh</p>
                    </div>
                </div>
            </div>
        </div>
